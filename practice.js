...
function first(arr) {   // Don't you mean aprameter, not argument?
  return arr[0]
}
...
function last(arr) {    // Parameter as well, not argument?
...
function looper(family) {   // Correct me if I'm wrong at this point, please.
